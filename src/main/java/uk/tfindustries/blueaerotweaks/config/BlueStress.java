...
//create's stress config stuff
public class BlueStress extends ConfigBase {
    ...
    public static <B extends Block, P> NonNullUnaryOperator<BlockBuilder<B, P>> setImpact(double value) {
        return builder -> {
            ...
            ResourceLocation id = BlueAeroTweaks.asResource(builder.getName());
    ...
    private static void assertFromCreate(BlockBuilder<?, ?> builder) {
        if (!builder.getOwner().getModid().equals(BlueAeroTweaks.MODID)) {
